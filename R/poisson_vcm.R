poisson_vcm <- function(formula, data, time, id = NULL,
                        method = "local-linear",
                        local_params = NULL,
  ...
  if (method == "local-linear"){
    if (is.null(local_params)){
      results <- poisson_local_vcm(formula = formula, data = data, time = time, 
      ...
      results <- poisson_local_vcm(formula = formula, data = data, time = time, id = id,
